...
- Webhook signature: base64 HMAC-SHA256 over f"{X-Hunar-Timestamp}.".encode() + raw body bytes,
  keyed by the API key. Comma-separated segments possible. hmac.compare_digest. Reject timestamps
  outside 300s.
